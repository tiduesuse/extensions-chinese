...
},{"./Parser":35,"paperback-extensions-common":12}],35:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    filterUpdatedManga($, time, ids) {
        ...
        for (let item of $('div.flex.bg-color-bg-secondary.p-2.rounded').toArray()) {
            let id = (_b = (_a = $('a.inilne.block', item).attr('href')) === null || _a === void 0 ? void 0 : _a.replace('/manga/', '')) !== null && _b !== void 0 ? _b : '';
            let mangaTime = new Date((_c = $('time-ago', item).attr('datetime')) !== null && _c !== void 0 ? _c : '');
    ...
    */
    parseRecentUpdatesSection($) {
        ...
        for (let obj of $('div.flex.bg-color-bg-secondary.p-2.rounded').toArray()) {
            let id = (_a = $('a.inilne.block', obj).attr('href')) === null || _a === void 0 ? void 0 : _a.replace('/manga/', '');
