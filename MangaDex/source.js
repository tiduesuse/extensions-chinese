...
class MangaDex extends paperback_extensions_common_1.Source {
    ...
    getCustomListRequestURL(listId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const json = (typeof response.data) === "string" ? JSON.parse(response.data) : response.data;
            return `${MANGADEX_API}/manga?limit=100&contentRating[]=safe&contentRating[]=suggestive&contentRating[]=erotica&contentRating[]=pornographic&includes[]=cover_art&ids[]=${((_b = (_a = json.data) === null || _a === void 0 ? void 0 : _a.relationships) !== null && _b !== void 0 ? _b : json.relationships).filter((x) => x.type == 'manga').map((x) => x.id).join('&ids[]=')}`;
        });
    }
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const author = ((_b = (_a = json.data) === null || _a === void 0 ? void 0 : _a.relationships) !== null && _b !== void 0 ? _b : json.relationships).filter((x) => x.type == 'author').map((x) => x.attributes.name).join(', ');
            const artist = ((_d = (_c = json.data) === null || _c === void 0 ? void 0 : _c.relationships) !== null && _d !== void 0 ? _d : json.relationships).filter((x) => x.type == 'artist').map((x) => x.attributes.name).join(', ');
            const coverFileName = ((_f = (_e = json.data) === null || _e === void 0 ? void 0 : _e.relationships) !== null && _f !== void 0 ? _f : json.relationships).filter((x) => x.type == 'cover_art').map((x) => { var _a; return (_a = x.attributes) === null || _a === void 0 ? void 0 : _a.fileName; })[0];
            let image;
            if (coverFileName) {
    ...
    getChapters(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                ...
                const json = (typeof response.data) === "string" ? JSON.parse(response.data) : response.data;
                offset += 500;
                const results = (_a = json.data) !== null && _a !== void 0 ? _a : json.results;
    ...
    searchRequest(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let results = [];
            const request = createRequestObject({
                url: `${MANGADEX_API}/manga?title=${encodeURIComponent((_b = query.title) !== null && _b !== void 0 ? _b : '')}&limit=100&offset=${offset}&contentRating[]=safe&contentRating[]=suggestive&contentRating[]=erotica&contentRating[]=pornographic&includes[]=cover_art`,
                method: 'GET',
            });
            const response = yield this.requestManager.schedule(request, 1);
            ...
            const json = (typeof response.data) === "string" ? JSON.parse(response.data) : response.data;
            const apiResults = (_c = json.data) !== null && _c !== void 0 ? _c : json.results;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const sections = [
                {
                    request: createRequestObject({
                        url: yield this.getCustomListRequestURL('a153b4e6-1fcc-4f45-a990-f37f989c0d74'),
                        method: 'GET',
                    }),
            ...
            for (const section of sections) {
                ...
                promises.push(this.requestManager.schedule(section.request, 1).then((response) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const json = (typeof response.data) === "string" ? JSON.parse(response.data) : response.data;
                    let results = [];
                    const apiResults = (_a = json.data) !== null && _a !== void 0 ? _a : json.results;
                    if (apiResults === undefined)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (loadNextPage) {
                ...
                for (const chapter of apiResults) {
                    const mangaId = (_b = chapter.relationships.filter((x) => x.type == 'manga')[0]) === null || _b === void 0 ? void 0 : _b.id;
...
},{"entities":2,"paperback-extensions-common":12}]},{},[34])(34)
});
